        ...
        <FooterLinksContainer>
          <FooterLinksWrapper>
            <FooterLinksItems>
              ...
              <FooterLink to='/' target='_blank'>Contact</FooterLink>
            ...
            <FooterLinksItems>
              ...
              <FooterLink to='/' target='_blank'>Books</FooterLink>
              <FooterLink to='/' target='_blank'>Support Groups</FooterLink>
            </FooterLinksItems>
            <FooterLinksItems>
              ...
              <FooterLink to='//www.youtube.co.uk' target='_blank'>YouTube</FooterLink>
            </FooterLinksItems>
            </FooterLinksWrapper>
        </FooterLinksContainer>
        <SocialMedia>
          <SocialMediaWrap>
            ...
            <SocialIcons>
              ...
              <SocialIconLink href='https://www.youtube.co.uk' target='_blank' aria-label='YouTube' rel='noopener noreferrer'><FaYoutube /></SocialIconLink>
            </SocialIcons>
          </SocialMediaWrap>
        </SocialMedia>
    </FooterContainer>
